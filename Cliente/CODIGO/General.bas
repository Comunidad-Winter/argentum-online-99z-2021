...
Exit Function 'GS
Err:
MsgBox "El servidor tiene un puerto invalido.", vbCritical
...
If FileExist(App.Path & "\init\ao.dat", vbNormal) Then
    ...
    'GS Nota -8 maximo ZoomOut 5 maximo ZoomIn
...
'frmMain.Inet1.URL = "http://www.argentum-online.com.ar/admin/iplist2.txt" 'GS
...
If FileExist(App.Path & "\init\servers.txt", vbNormal) Then 'GS
...
Do While prgRun
    ...
    If EngineRun Then
        ...
        '[END]'
            ...
            '****** Update screen ******
            Call RenderScreen(UserPos.X - AddtoUserPos.X, UserPos.Y - AddtoUserPos.Y, OffsetCounterX + 20, OffsetCounterY + 20)
            'Call DoNightFX
