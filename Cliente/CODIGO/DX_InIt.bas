...
Dim CambiarResolucion As Boolean 'GS
Dim choiceRes As Long
choiceRes = MsgBox("Desea adaptar la configuracion de la pantalla a 800x600?", vbYesNo)
If choiceRes = 6 Then
